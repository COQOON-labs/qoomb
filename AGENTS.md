...
This project is indexed by GitNexus as **qoomb** (1567 symbols, 4468 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/qoomb/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/qoomb/context` | Codebase overview, check index freshness |
| `gitnexus://repo/qoomb/clusters` | All functional areas |
| `gitnexus://repo/qoomb/processes` | All execution flows |
| `gitnexus://repo/qoomb/process/{name}` | Step-by-step execution trace |
