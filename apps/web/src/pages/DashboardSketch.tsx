 ...
 *
 * Eingefrorene Skizze des Dashboards mit statischen Dummy-Daten.
 * Dient als Inspirationsquelle und Designvorlage für die echte Implementierung.
 *
 * Erreichbar über: /dev/sketch/dashboard (nur im Dev-Modus)
 *
 * NICHT für Produktion! Kein tRPC, keine echten Daten.
 */
...
export function DashboardSketch() {
  ...
  return (
    <AppShell>
      {/* ── Sketch-Banner ────────────────────────────────────────────────────── */}
      <div className="mx-4 md:mx-8 mt-4 px-4 py-2.5 rounded-xl bg-amber-100 border border-amber-300 text-amber-800 text-xs font-semibold flex items-center gap-2">
        <span>⚡ Designskizze</span>
        <span className="font-normal opacity-70">— Statische Dummy-Daten, kein echtes Backend</span>
      </div>
