...
const de = {
  ...
  lists: {
    ...
    deleteViewConfirm: 'Ansicht „{name}" wirklich löschen?',
    duplicateView: 'Ansicht duplizieren',
    duplicateViewSuffix: '(Kopie)',
    renameView: 'Ansicht umbenennen',
    viewDeleted: 'Ansicht gelöscht',
    viewRenamed: 'Ansicht umbenannt',
    viewUpdated: 'Ansicht aktualisiert',
    lastViewWarning: 'Die letzte Ansicht kann nicht gelöscht werden.',
    // Kanban view
