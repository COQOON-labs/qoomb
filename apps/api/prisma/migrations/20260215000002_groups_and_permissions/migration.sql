...
CREATE UNIQUE INDEX "hive_role_permissions_hive_id_role_permission_key" ON "hive_role_permissions" (
    "hive_id",
    "role",
    "permission"
);
...
CREATE UNIQUE INDEX "person_shares_resource_type_resource_id_person_id_key" ON "person_shares" (
    "resource_type",
    "resource_id",
    "person_id"
);

CREATE INDEX "person_shares_hive_id_resource_type_resource_id_idx" ON "person_shares" (
    "hive_id",
    "resource_type",
    "resource_id"
);

CREATE UNIQUE INDEX "group_shares_resource_type_resource_id_group_id_key" ON "group_shares" (
    "resource_type",
    "resource_id",
    "group_id"
);

CREATE INDEX "group_shares_hive_id_resource_type_resource_id_idx" ON "group_shares" (
    "hive_id",
    "resource_type",
    "resource_id"
);
